/**
 * 🚀 FREE PDF GENERATION FOR ZAPIER
 * 
 * Paste this ENTIRE code into "Code by Zapier" (Run JavaScript)
 * 
 * INPUT DATA (Map from previous steps):
 * - inputData.analysis_json (your GPT analysis output)
 ...
 * 
 * OUTPUT:
 * - pdf_base64: Base64 encoded PDF (ready to save to file)
...
output = await generatePDF(inputData);
